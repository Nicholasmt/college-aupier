...
@error('first_name') <span class="text-danger font_13 text-capitalize">{{$message}}</span> @enderror
</div> 
<div class="form-group">
...
@error('last_name') <span class="text-danger font_13 text-capitalize">{{$message}}</span> @enderror
</div>  
<div class="form-group">
...
<label for="location">Where are you located?*</label>
 ...
 @error('country') <span class="text-danger font_13 text-capitalize">{{$message}}</span> @enderror
</div>

<div class="form-group">
<label for="student_name">Student Full Name</label>
<input type="text" class="form-control" wire:model="student_full_name" placeholder="Student Name">
@error('student_full_name') <span class="text-danger font_13 text-capitalize">{{$message}}</span> @enderror
</div> 

<div class="row">
<div class="col-lg-6 col-md-6 col-xs-12">
<label for="current_year">Current School Year</label>
<input type="month" class="form-control" wire:model="current_year" placeholder="Current Year">
@error('current_year') <span class="text-danger font_13 text-capitalize">{{$message}}</span> @enderror
</div>
<div class="col-lg-6 col-md-6 col-xs-12">
<label for="graduation_year">Student's Graduation Year</label>
<input type="month" class="form-control" wire:model="graduation_year" placeholder="Graduation Year">
@error('graduation_year') <span class="text-danger font_13 text-capitalize">{{$message}}</span> @enderror
</div>
</div> 

<div class="form-group">
<label for="about-student">Tell us more about your student</label>
<textarea wire:model="about_student"  class="form-control" id="" cols="30" rows="5"></textarea>
@error('about_student') <span class="text-danger font_13 text-capitalize">{{$message}}</span> @enderror
</div>

<div class="form-group">
<label for="location">How can we help you?</label>
<select wire:model="service_needed" class="form-control">
<option value="">Please Select</option>
<option value="Middle Schools">Middle Schools</option>
<option value="Freshmen">Fresmen</option>
<option value="Sophomores">Sophomores</option>
<option value="Junior">Junior</option>
<option value="Senior">Senior</option>
</select>
@error('service_needed') <span class="text-danger font_13 text-capitalize">{{$message}}</span> @enderror
</div>

<div class="row">
<div class="col-lg-6 col-md-6 col-xs-12">
<label for="hear about us">How did you hear about us?</label>
<select wire:model="hear_about_us" class="form-control">
<option value="">Please Select</option>
...
@error('hear_about_us') <span class="text-danger font_13 text-capitalize">{{$message}}</span> @enderror
</div>
<div class="col-lg-6 col-md-6 col-xs-12">
<label for="when_to_start">How soon would you like to start working with us?</label>
<select wire:model="when_to_start" class="form-control">
<option value="">Please Select</option>
<option value="Immediately">Immediately</option>
<option value="Within the next 3 months">Within the next 3 months</option>
<option value="Not sure">Not sure</option>
</select>
@error('when_to_start') <span class="text-danger font_13 text-capitalize">{{$message}}</span> @enderror
</div>
</div> 
<div class="form-group mt-5">
<input type="checkbox" wire:model="terms_and_conditions">
<label for="terms_of_service" class="ml-2">I agree to the <a href="#" class="text-color">terms and conditions</a> and  <a href="" class="text-color">privacy policy</a></label> <br>
@error('terms_and_conditions') <span class="text-danger font_13 text-capitalize">{{$message}}</span> @enderror
</div>
<div class="form-group">
<button wire:click.prevent="book_consultation" class="btn btn-common">Submit</button>
</div>
@if(Session::has('message'))
<div class="alert alert-success">
<p class="text-capitalize font_14"> {{Session::get('message')}} </p> 
</div>
@endif
</div>
{{-- </form> --}}
